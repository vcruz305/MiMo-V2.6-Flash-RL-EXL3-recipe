...
say "done: $OUT"
echo
echo "Compare a fresh run against the numbers in README 'Measured results':"
echo "  decode single-stream p50   47.63 tok/s (no draft)   184.46 tok/s (with the corrected drafter)"
echo "  prefill single-stream p50  2,521.4 tok/s            2,404.4 tok/s"
